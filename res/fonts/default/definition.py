"""
Default font definition for gen_font.py directory discovery.

Generates: res/font.c / res/font.h

The font covers ASCII 32-127 (96 chars) plus 5 extra glyphs at indices 96-100:
  96 - spade, 97 - club, 98 - heart, 99 - diamond, 100 - cursor arrow
...
# ---------------------------------------------------------------------------
# Font palette (default: sky-blue bg, black text)
# ---------------------------------------------------------------------------
PALETTE_COLORS = [
